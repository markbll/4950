...
$secret = app_secret();
$storage = storage_dir();
echo json_encode(['secret' => $secret !== null, 'storage' => $storage === realpath("$root/web/_private") . '/storage', 'quotes' => env('SMTP_PASS') === "ab\"cd'" && env('MAIL_FROM_NAME') === 'Big Cat']);
